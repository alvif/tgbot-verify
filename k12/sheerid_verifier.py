...
# Mendukung impor sebagai paket maupun eksekusi langsung
try:
...
class SheerIDVerifier:
    ...
    def __init__(self, verification_id: str):
        ...
        Args:
            verification_id: ID verifikasi SheerID
        """
    ...
    def __del__(self):
        """Bersihkan klien HTTP"""
        if hasattr(self, 'http_client'):
            self.http_client.close()

    @staticmethod
    def _generate_device_fingerprint() -> str:
        """Hasilkan sidik jari perangkat"""
    ...
    def verify(self, first_name: str = None, last_name: str = None,
        ...
        """
        Jalankan alur verifikasi lengkap tanpa polling status untuk menghemat waktu
        """
        try:
            current_step = 'initial'

            # Bangun informasi guru
            ...
            # Hasilkan PDF + PNG bukti guru
            logger.info("Langkah 1/4: buat PDF dan PNG bukti guru...")
            ...
            # Langkah 2: kirim info guru
            logger.info("Langkah 2/4: kirim info guru...")
            step2_body = {
            ...
            # Langkah 3: lewati SSO (jika perlu)
            ...
            # Langkah 4: unggah dokumen dan selesaikan pengiriman
            ...
            if not self._upload_to_s3(pdf_upload_url, pdf_data, 'application/pdf'):
                raise Exception("Gagal mengunggah PDF")
            if not self._upload_to_s3(png_upload_url, png_data, 'image/png'):
                raise Exception("Gagal mengunggah PNG")
            logger.info("✓ Berhasil mengunggah PDF/PNG bukti guru")
